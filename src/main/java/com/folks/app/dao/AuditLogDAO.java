...
public interface AuditLogDAO {
     ...
     * @param record    AuditLog entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<AuditLog> records);
     ...
     * 
     * @param record    AuditLog entry to be updated
     */
    void update(AuditLog record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<AuditLog> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    AuditLog entry to be deleted.
     */
    void delete(AuditLog record);
     ...
     */
    @NotSupported
    AuditLog find(AuditLog.AuditLogPK pk);
     ...
     */
    @NotSupported
    List<AuditLog> query(SearchCriteria search);
}
