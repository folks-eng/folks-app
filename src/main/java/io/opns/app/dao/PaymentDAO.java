...
public interface PaymentDAO {
     ...
     * @param record    Payment entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Payment> records);
     ...
     * 
     * @param record    Payment entry to be updated
     */
    void update(Payment record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Payment> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Payment entry to be deleted.
     */
    void delete(Payment record);
     ...
     */
    @NotSupported
    Payment find(Payment.PaymentPK pk);
     ...
     */
    @NotSupported
    List<Payment> query(SearchCriteria search);
}
