...
public interface DocumentDAO {
     ...
     * @param record    Document entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Document> records);
     ...
     * 
     * @param record    Document entry to be updated
     */
    void update(Document record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Document> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Document entry to be deleted.
     */
    void delete(Document record);
     ...
     */
    @NotSupported
    Document find(Document.DocumentPK pk);
