...
/**
 * Data Access Object for JobStatus table.
 *
 * <p>
...
public interface JobStatusDAO {
     ...
     * @param record    JobStatus entry to be created
     */
    void insert(JobStatus record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<JobStatus> records);
     ...
     * 
     * @param record    JobStatus entry to be updated
     */
    void update(JobStatus record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<JobStatus> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    JobStatus entry to be deleted.
     */
    void delete(JobStatus record);
     ...
     */
    @NotSupported
    JobStatus find(JobStatus.JobStatusPK pk);
     ...
     */
    @NotSupported
    List<JobStatus> query(SearchCriteria search);
}
