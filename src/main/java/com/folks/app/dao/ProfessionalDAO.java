...
/**
 * Data Access Object for Professional table.
 *
 * <p>
...
public interface ProfessionalDAO {
     ...
     */
    void insert(Professional record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<Professional> records);
     ...
     * 
     * @param record    Professional entry to be updated
     */
    void update(Professional record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Professional> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Professional entry to be deleted.
     */
    void delete(Professional record);
