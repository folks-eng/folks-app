...
/**
 * Data Access Object for Country table.
 *
 * <p>
...
public interface CountryDAO {
     ...
     * @param record    Country entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Country> records);
     ...
     * 
     * @param record    Country entry to be updated
     */
    void update(Country record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Country> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Country entry to be deleted.
     */
    void delete(Country record);
     ...
     */
    @NotSupported
    Country find(Country.CountryPK pk);
     ...
     */
    @NotSupported
    List<Country> query(SearchCriteria search);
}
