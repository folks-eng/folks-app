...
/**
 * Data Access Object for Wallet table.
 *
 * <p>
...
public interface WalletDAO {
     ...
     * @param record    Wallet entry to be created
     */
    void insert(Wallet record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<Wallet> records);
     ...
     * 
     * @param record    Wallet entry to be updated
     */
    void update(Wallet record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Wallet> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Wallet entry to be deleted.
     */
    void delete(Wallet record);
     ...
     */
    @NotSupported
    Wallet find(Wallet.WalletPK pk);
     ...
     */
    @NotSupported
    List<Wallet> query(SearchCriteria search);
}
