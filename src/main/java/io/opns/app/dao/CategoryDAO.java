...
public interface CategoryDAO {
     ...
     * @param record    Category entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Category> records);
     ...
     * 
     * @param record    Category entry to be updated
     */
     ...
     * @param records 
     */
    void update(List<Category> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Category entry to be deleted.
     */
     ...
     */
    @NotSupported
    Category find(Category.CategoryPK pk);
