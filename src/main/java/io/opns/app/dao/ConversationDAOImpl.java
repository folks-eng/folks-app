...
public class ConversationDAOImpl implements ConversationDAO {
    ...
    private final String TABLE = "fks_conversations";
    ...
    @Override
    public void insert(List<Conversation> records) {
    ...
    @Override
    public void update(List<Conversation> records) {
        for (Conversation record : records) {
            em.merge(record);
        }
    }
    ...
    @Override
    public void delete(Conversation record) {
        em.remove(record);
    }

    @Override
    public Conversation find(Conversation.ConversationPK pk) {
        return em.find(Conversation.class, pk);
    }

    @Override
    public List<Conversation> query(SearchCriteria search) {
        ...
        TypedQuery q = em.createNativeQuery(query.toQuery(), Conversation.class);
