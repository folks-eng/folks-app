...
/**
 * Data Access Object for PanInfo table.
 *
 * <p>
...
public interface PanInfoDAO {
     ...
     * @param record    PanInfo entry to be created
     */
    void insert(PanInfo record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<PanInfo> records);
     ...
     * 
     * @param record    PanInfo entry to be updated
     */
    void update(PanInfo record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<PanInfo> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    PanInfo entry to be deleted.
     */
    void delete(PanInfo record);
     ...
     */
    @NotSupported
    PanInfo find(PanInfo.PanInfoPK pk);
     ...
     */
    @NotSupported
    List<PanInfo> query(SearchCriteria search);
}
