...
public interface UserDAO {
     ...
     * @param record    User entry to be created
     */
     ...
     * 
     * @param record    User entry to be updated
     */
     ...
     * @param records 
     */
    void update(List<User> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    User entry to be deleted.
     */
     ...
     */
    @NotSupported
    List<User> query(SearchCriteria search);
}
