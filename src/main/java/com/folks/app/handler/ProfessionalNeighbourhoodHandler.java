...
import com.folks.app.bo.ProfessionalNeighbourhoodBO;
 ...
 */
public class ProfessionalNeighbourhoodHandler extends AbstractHandler {
    
    private final ProfessionalNeighbourhoodBO professionalNeighbourhoodBO;
    
    public ProfessionalNeighbourhoodHandler(Vertx vertx) {
        super(vertx);
        this.professionalNeighbourhoodBO = new ProfessionalNeighbourhoodBO();
    }
    ...
    public void create(RoutingContext ctx) {
        ...
        vertx().executeBlocking(() -> {
            ProfessionalNeighbourhood professionalNeighbourhood = MapperUtil.decode(ctx.body().buffer().getBytes(), ProfessionalNeighbourhood.class);
            professionalNeighbourhood = professionalNeighbourhoodBO.create(user(ctx), professionalNeighbourhood);
    ...
    public void batchCreate(RoutingContext ctx) {
        // If you use a remote store, this method will safely execute the blocking code.
        vertx().executeBlocking(() -> {
            List<ProfessionalNeighbourhood> list = MapperUtil.mapper().readValue(ctx.body().buffer().getBytes(), new TypeReference<List<ProfessionalNeighbourhood>>() {});
            professionalNeighbourhoodBO.create(user(ctx), list);
    ...
    public void modify(RoutingContext ctx) {
        ...
        vertx().executeBlocking(() -> {
            ProfessionalNeighbourhood professionalNeighbourhood = MapperUtil.decode(ctx.body().buffer().getBytes(), ProfessionalNeighbourhood.class);
            professionalNeighbourhood.setId(Integer.valueOf(id));


            // First fetch the entry, to see if this already exists.
            ProfessionalNeighbourhood rs = professionalNeighbourhoodBO.modify(user(ctx), professionalNeighbourhood);

            ServerMessage msg = new ServerMessage();
            msg.setCode(HttpURLConnection.HTTP_OK);
            msg.setMessage("ProfessionalNeighbourhood modified successfully");
    ...
    public void view(RoutingContext ctx) {
        ...
        // If you use a remote store, this method will safely execute the blocking code.
        vertx().executeBlocking(() -> {
            ProfessionalNeighbourhood professionalNeighbourhood = professionalNeighbourhoodBO.view(user(ctx), Integer.valueOf(id));
    ...
    public void viewAll(RoutingContext ctx) {
        ...
        vertx().executeBlocking(() -> {
            List<ProfessionalNeighbourhood> professionalNeighbourhoods = professionalNeighbourhoodBO.viewAll(user(ctx), params);
            List<Object> rows = (List)professionalNeighbourhoods;
    ...
    public void remove(RoutingContext ctx) {
        ...
        // If you use a remote store, this method will safely execute the blocking code.
        vertx().executeBlocking(() -> {
            ProfessionalNeighbourhood professionalNeighbourhood = professionalNeighbourhoodBO.remove(user(ctx), Integer.valueOf(id));

            ServerMessage msg = new ServerMessage();
            msg.setCode(HttpURLConnection.HTTP_NO_CONTENT);
            msg.setMessage("ProfessionalNeighbourhood deleted successfully");
