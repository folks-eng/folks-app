...
/**
 * Data Access Object for OperatingCity table.
 *
 * <p>
...
public interface CityDAO {
     ...
     * @param record    OperatingCity entry to be created
     */
     ...
     * 
     * @param record    OperatingCity entry to be updated
     */
     ...
     * @param records 
     */
    void update(List<City> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    OperatingCity entry to be deleted.
     */
    void delete(City record);
     ...
     */
    @NotSupported
    List<City> query(SearchCriteria search);
}
