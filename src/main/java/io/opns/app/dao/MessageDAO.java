...
public interface MessageDAO {
     ...
     * @param record    Message entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Message> records);
     ...
     * 
     * @param record    Message entry to be updated
     */
     ...
     * @param records 
     */
    void update(List<Message> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Message entry to be deleted.
     */
    void delete(Message record);
     ...
     */
    @NotSupported
    Message find(Message.MessagePK pk);
     ...
     */
    @NotSupported
    List<Message> query(SearchCriteria search);
}
