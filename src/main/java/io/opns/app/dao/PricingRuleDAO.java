...
/**
 * Data Access Object for PricingRule table.
 *
 * <p>
...
public interface PricingRuleDAO {
     ...
     * @param record    PricingRule entry to be created
     */
    void insert(PricingRule record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<PricingRule> records);
     ...
     * 
     * @param record    PricingRule entry to be updated
     */
    void update(PricingRule record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<PricingRule> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    PricingRule entry to be deleted.
     */
    void delete(PricingRule record);
     ...
     */
    @NotSupported
    PricingRule find(PricingRule.PricingRulePK pk);
     ...
     */
    @NotSupported
    List<PricingRule> query(SearchCriteria search);
}
