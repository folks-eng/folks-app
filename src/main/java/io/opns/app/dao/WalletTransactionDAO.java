...
/**
 * Data Access Object for WalletTransaction table.
 *
 * <p>
...
public interface WalletTransactionDAO {
     ...
     * @param record    WalletTransaction entry to be created
     */
    void insert(WalletTransaction record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<WalletTransaction> records);
     ...
     * 
     * @param record    WalletTransaction entry to be updated
     */
    void update(WalletTransaction record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<WalletTransaction> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    WalletTransaction entry to be deleted.
     */
    void delete(WalletTransaction record);
     ...
     */
    @NotSupported
    WalletTransaction find(WalletTransaction.WalletTransactionPK pk);
     ...
     */
    @NotSupported
    List<WalletTransaction> query(SearchCriteria search);
}
