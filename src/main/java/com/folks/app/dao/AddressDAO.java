...
public interface AddressDAO {
     ...
     * @param record    Address entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Address> records);
     ...
     * 
     * @param record    Address entry to be updated
     */
    void update(Address record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Address> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Address entry to be deleted.
     */
