...
public class CouponDAOImpl implements CouponDAO {
    ...
    private final String TABLE = "fks_coupons";
    
    @PersistenceContext(name = "folks-app-pu")
    private EntityManager em;
    
    @Override
    public void insert(Coupon record) {
        insert(Arrays.asList(record));
    }

    @Override
    public void insert(List<Coupon> records) {
    ...
    @Override
    public void update(List<Coupon> records) {
        for (Coupon record : records) {
            em.merge(record);
        }
    }
    ...
    @Override
    public void delete(Coupon record) {
        em.remove(record);
    }

    @Override
    public Coupon find(Coupon.CouponPK pk) {
        return em.find(Coupon.class, pk);
    }

    @Override
    public List<Coupon> query(SearchCriteria search) {
        ...
        TypedQuery q = em.createNativeQuery(query.toQuery(), Coupon.class);
        ...
        List<Coupon> result = q.getResultList();
        return result;
    }
