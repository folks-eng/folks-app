...
/**
 * Data Access Object for Province table.
 *
 * <p>
...
public interface ProvinceDAO {
     ...
     * @param record    Province entry to be created
     */
     ...
     * @param records 
     */
    void insert(List<Province> records);
     ...
     * 
     * @param record    Province entry to be updated
     */
    void update(Province record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Province> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Province entry to be deleted.
     */
    void delete(Province record);
     ...
     */
    @NotSupported
    Province find(Province.ProvincePK pk);
     ...
     */
    @NotSupported
    List<Province> query(SearchCriteria search);
}
