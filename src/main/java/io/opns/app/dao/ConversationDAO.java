...
public interface ConversationDAO {
     ...
     * @param record    Conversation entry to be created
     */
    void insert(Conversation record);
    
    /**
     * A bulk insert method to create multiple records at once.
     * @param records 
     */
    void insert(List<Conversation> records);
     ...
     * 
     * @param record    Conversation entry to be updated
     */
    void update(Conversation record);
    
    /**
     * Bulk update multiple records.
     * @param records 
     */
    void update(List<Conversation> records);
    
    /**
     * Delete the specific entry from the database.
     * @param record    Conversation entry to be deleted.
     */
    void delete(Conversation record);
     ...
     */
    @NotSupported
    Conversation find(Conversation.ConversationPK pk);
     ...
     */
    @NotSupported
    List<Conversation> query(SearchCriteria search);
}
